            ...
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                        ...
                        <DialogDescription>Update your profile deatails here.</DialogDescription>
                    </DialogHeader>
                        ...
                        <DialogFooter>
                {
                     ...
                     Please wait </Button>: <Button type="submit" className="w-full my-4">Update</Button>
                    }
                        </DialogFooter>
                    </form>
                </DialogContent>
